...
NumberOfBytesInDecodedWord =fgetl(cabecalho_id);
...
texto_decodificado=blanks(str2num(NumberOfBytesInDecodedWord));
c = 1;
while ponteiro<length(texto_codificado)
    ...
    texto_decodificado(c)=range_table{index, 3};
    c = c+1;
...
decoded_bitstream = texto_decodificado;
offset = offset;
